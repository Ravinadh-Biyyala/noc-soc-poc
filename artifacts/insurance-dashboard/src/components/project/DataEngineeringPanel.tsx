...
import {
  ...
  CheckCircle2, XCircle, Trash2, AlertTriangle, ChevronDown, ChevronRight, GitMerge, Filter, Layers, Sparkles,
} from "lucide-react";
...
export function ProjectRawBrowserPanel({
  ...
  return <RawBrowser projectId={projectId} autoMode={autoMode} onDashboardCreated={onDashboardCreated} />;
}
    ...
    <div className="space-y-3">
      ...
      {autoMode && (
        <AutoGenerateDialog
          ...
          projectId={projectId}
          onCreated={(dashId) => onDashboardCreated?.(dashId)}
        />
      )}
    </div>
  );
